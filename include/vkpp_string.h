...
const char * to_string(ImageType val) {
    switch(val) {
        case(ImageType::1D): return "1D";
        case(ImageType::2D): return "2D";
        case(ImageType::3D): return "3D";
        default: return "UNKNOWN";
    }
}
...
const char * to_string(ImageViewType val) {
    switch(val) {
        case(ImageViewType::1D): return "1D";
        case(ImageViewType::2D): return "2D";
        case(ImageViewType::3D): return "3D";
        case(ImageViewType::Cube): return "Cube";
        case(ImageViewType::1DArray): return "1DArray";
        case(ImageViewType::2DArray): return "2DArray";
...
const char * to_string(QueryType val) {
    switch(val) {
        ...
        case(QueryType::Reserved8): return "Reserved8";
        case(QueryType::Reserved4): return "Reserved4";
...
const char * to_string(Format val) {
    switch(val) {
        ...
        case(Format::Astc3X3X3UnormBlockEXT): return "Astc3X3X3UnormBlockEXT";
        case(Format::Astc3X3X3SrgbBlockEXT): return "Astc3X3X3SrgbBlockEXT";
        case(Format::Astc3X3X3SfloatBlockEXT): return "Astc3X3X3SfloatBlockEXT";
        case(Format::Astc4X3X3UnormBlockEXT): return "Astc4X3X3UnormBlockEXT";
        case(Format::Astc4X3X3SrgbBlockEXT): return "Astc4X3X3SrgbBlockEXT";
        case(Format::Astc4X3X3SfloatBlockEXT): return "Astc4X3X3SfloatBlockEXT";
        case(Format::Astc4X4X3UnormBlockEXT): return "Astc4X4X3UnormBlockEXT";
        case(Format::Astc4X4X3SrgbBlockEXT): return "Astc4X4X3SrgbBlockEXT";
        case(Format::Astc4X4X3SfloatBlockEXT): return "Astc4X4X3SfloatBlockEXT";
        case(Format::Astc4X4X4UnormBlockEXT): return "Astc4X4X4UnormBlockEXT";
        case(Format::Astc4X4X4SrgbBlockEXT): return "Astc4X4X4SrgbBlockEXT";
        case(Format::Astc4X4X4SfloatBlockEXT): return "Astc4X4X4SfloatBlockEXT";
        case(Format::Astc5X4X4UnormBlockEXT): return "Astc5X4X4UnormBlockEXT";
        case(Format::Astc5X4X4SrgbBlockEXT): return "Astc5X4X4SrgbBlockEXT";
        case(Format::Astc5X4X4SfloatBlockEXT): return "Astc5X4X4SfloatBlockEXT";
        case(Format::Astc5X5X4UnormBlockEXT): return "Astc5X5X4UnormBlockEXT";
        case(Format::Astc5X5X4SrgbBlockEXT): return "Astc5X5X4SrgbBlockEXT";
        case(Format::Astc5X5X4SfloatBlockEXT): return "Astc5X5X4SfloatBlockEXT";
        case(Format::Astc5X5X5UnormBlockEXT): return "Astc5X5X5UnormBlockEXT";
        case(Format::Astc5X5X5SrgbBlockEXT): return "Astc5X5X5SrgbBlockEXT";
        case(Format::Astc5X5X5SfloatBlockEXT): return "Astc5X5X5SfloatBlockEXT";
        case(Format::Astc6X5X5UnormBlockEXT): return "Astc6X5X5UnormBlockEXT";
        case(Format::Astc6X5X5SrgbBlockEXT): return "Astc6X5X5SrgbBlockEXT";
        case(Format::Astc6X5X5SfloatBlockEXT): return "Astc6X5X5SfloatBlockEXT";
        case(Format::Astc6X6X5UnormBlockEXT): return "Astc6X6X5UnormBlockEXT";
        case(Format::Astc6X6X5SrgbBlockEXT): return "Astc6X6X5SrgbBlockEXT";
        case(Format::Astc6X6X5SfloatBlockEXT): return "Astc6X6X5SfloatBlockEXT";
        case(Format::Astc6X6X6UnormBlockEXT): return "Astc6X6X6UnormBlockEXT";
        case(Format::Astc6X6X6SrgbBlockEXT): return "Astc6X6X6SrgbBlockEXT";
        case(Format::Astc6X6X6SfloatBlockEXT): return "Astc6X6X6SfloatBlockEXT";
...
const char * to_string(StructureType val) {
    switch(val) {
        ...
        case(StructureType::NativeBufferANDROID): return "NativeBufferANDROID";
        case(StructureType::SwapchainImageCreateInfoANDROID): return "SwapchainImageCreateInfoANDROID";
        case(StructureType::PhysicalDevicePresentationPropertiesANDROID): return "PhysicalDevicePresentationPropertiesANDROID";
        ...
        case(StructureType::ReservedQCOM): return "ReservedQCOM";
...
const char * to_string(ShadingRatePaletteEntryNV val) {
    switch(val) {
        ...
        case(ShadingRatePaletteEntryNV::16InvocationsPerPixelNV): return "16InvocationsPerPixelNV";
        case(ShadingRatePaletteEntryNV::8InvocationsPerPixelNV): return "8InvocationsPerPixelNV";
        case(ShadingRatePaletteEntryNV::4InvocationsPerPixelNV): return "4InvocationsPerPixelNV";
        case(ShadingRatePaletteEntryNV::2InvocationsPerPixelNV): return "2InvocationsPerPixelNV";
        case(ShadingRatePaletteEntryNV::1InvocationPerPixelNV): return "1InvocationPerPixelNV";
        case(ShadingRatePaletteEntryNV::1InvocationPer2X1PixelsNV): return "1InvocationPer2X1PixelsNV";
        case(ShadingRatePaletteEntryNV::1InvocationPer1X2PixelsNV): return "1InvocationPer1X2PixelsNV";
        case(ShadingRatePaletteEntryNV::1InvocationPer2X2PixelsNV): return "1InvocationPer2X2PixelsNV";
        case(ShadingRatePaletteEntryNV::1InvocationPer4X2PixelsNV): return "1InvocationPer4X2PixelsNV";
        case(ShadingRatePaletteEntryNV::1InvocationPer2X4PixelsNV): return "1InvocationPer2X4PixelsNV";
        case(ShadingRatePaletteEntryNV::1InvocationPer4X4PixelsNV): return "1InvocationPer4X4PixelsNV";
        default: return "UNKNOWN";
    }
}
...
const char * to_string(ShaderFloatControlsIndependence val) {
    switch(val) {
        case(ShaderFloatControlsIndependence::32BitOnly): return "32BitOnly";
...
const char * to_string(QueueFlagBits val) {
    switch(val) {
        ...
        case(QueueFlagBits::Reserved6BitKHR): return "Reserved6BitKHR";
        case(QueueFlagBits::Reserved5BitKHR): return "Reserved5BitKHR";
...
const char * to_string(RenderPassCreateFlagBits val) {
    switch(val) {
        case(RenderPassCreateFlagBits::Reserved0BitKHR): return "Reserved0BitKHR";
...
const char * to_string(MemoryHeapFlagBits val) {
    switch(val) {
        ...
        case(MemoryHeapFlagBits::Reserved2BitKHR): return "Reserved2BitKHR";
...
const char * to_string(AccessFlagBits val) {
    switch(val) {
        ...
        case(AccessFlagBits::Reserved30BitKHR): return "Reserved30BitKHR";
        case(AccessFlagBits::Reserved28BitKHR): return "Reserved28BitKHR";
        case(AccessFlagBits::Reserved29BitKHR): return "Reserved29BitKHR";
...
const char * to_string(BufferUsageFlagBits val) {
    switch(val) {
        ...
        case(BufferUsageFlagBits::Reserved15BitKHR): return "Reserved15BitKHR";
        case(BufferUsageFlagBits::Reserved16BitKHR): return "Reserved16BitKHR";
        case(BufferUsageFlagBits::Reserved13BitKHR): return "Reserved13BitKHR";
        case(BufferUsageFlagBits::Reserved14BitKHR): return "Reserved14BitKHR";
        ...
        case(BufferUsageFlagBits::Reserved19BitKHR): return "Reserved19BitKHR";
        case(BufferUsageFlagBits::Reserved20BitKHR): return "Reserved20BitKHR";
        case(BufferUsageFlagBits::Reserved18BitQCOM): return "Reserved18BitQCOM";
...
const char * to_string(ImageUsageFlagBits val) {
    switch(val) {
        ...
        case(ImageUsageFlagBits::Reserved13BitKHR): return "Reserved13BitKHR";
        case(ImageUsageFlagBits::Reserved14BitKHR): return "Reserved14BitKHR";
        case(ImageUsageFlagBits::Reserved15BitKHR): return "Reserved15BitKHR";
        case(ImageUsageFlagBits::Reserved10BitKHR): return "Reserved10BitKHR";
        case(ImageUsageFlagBits::Reserved11BitKHR): return "Reserved11BitKHR";
        case(ImageUsageFlagBits::Reserved12BitKHR): return "Reserved12BitKHR";
        case(ImageUsageFlagBits::ShadingRateImageBitNV): return "ShadingRateImageBitNV";
        case(ImageUsageFlagBits::Reserved16BitQCOM): return "Reserved16BitQCOM";
        case(ImageUsageFlagBits::Reserved17BitQCOM): return "Reserved17BitQCOM";
...
const char * to_string(ImageCreateFlagBits val) {
    switch(val) {
        ...
        case(ImageCreateFlagBits::2DArrayCompatible): return "2DArrayCompatible";
...
const char * to_string(PipelineCreateFlagBits val) {
    switch(val) {
        ...
        case(PipelineCreateFlagBits::Reserved19BitKHR): return "Reserved19BitKHR";
...
const char * to_string(PipelineShaderStageCreateFlagBits val) {
    switch(val) {
        case(PipelineShaderStageCreateFlagBits::Reserved2BitNV): return "Reserved2BitNV";
        ...
        case(PipelineShaderStageCreateFlagBits::Reserved3BitKHR): return "Reserved3BitKHR";
        default: return "UNKNOWN";
    }
}
...
const char * to_string(FormatFeatureFlagBits val) {
    switch(val) {
        ...
        case(FormatFeatureFlagBits::Reserved27BitKHR): return "Reserved27BitKHR";
        case(FormatFeatureFlagBits::Reserved28BitKHR): return "Reserved28BitKHR";
        case(FormatFeatureFlagBits::Reserved25BitKHR): return "Reserved25BitKHR";
        case(FormatFeatureFlagBits::Reserved26BitKHR): return "Reserved26BitKHR";
        ...
        case(FormatFeatureFlagBits::AmdReserved30): return "AmdReserved30";
...
const char * to_string(QueryResultFlagBits val) {
    switch(val) {
        case(QueryResultFlagBits::64): return "64";
...
const char * to_string(PipelineStageFlagBits val) {
    switch(val) {
        ...
        case(PipelineStageFlagBits::Reserved27BitKHR): return "Reserved27BitKHR";
        case(PipelineStageFlagBits::Reserved26BitKHR): return "Reserved26BitKHR";
...
const char * to_string(SampleCountFlagBits val) {
    switch(val) {
        case(SampleCountFlagBits::1): return "1";
        case(SampleCountFlagBits::2): return "2";
        case(SampleCountFlagBits::4): return "4";
        case(SampleCountFlagBits::8): return "8";
        case(SampleCountFlagBits::16): return "16";
        case(SampleCountFlagBits::32): return "32";
        case(SampleCountFlagBits::64): return "64";
        default: return "UNKNOWN";
    }
}
...
const char * to_string(StencilFaceFlagBits val) {
    switch(val) {
        ...
        case(StencilFaceFlagBits::FrontAndBack): return "FrontAndBack";
        case(StencilFaceFlagBits::AndBack): return "AndBack";
        default: return "UNKNOWN";
    }
}
...
const char * to_string(SwapchainImageUsageFlagBitsANDROID val) {
    switch(val) {
        case(SwapchainImageUsageFlagBitsANDROID::SharedBitANDROID): return "SharedBitANDROID";
        default: return "UNKNOWN";
    }
}
...
const char * to_string(ExternalSemaphoreHandleTypeFlagBits val) {
    switch(val) {
        ...
        case(ExternalSemaphoreHandleTypeFlagBits::D3D11Fence): return "D3D11Fence";
...
const char * to_string(ShaderModuleCreateFlagBits val) {
    switch(val) {
        case(ShaderModuleCreateFlagBits::Reserved0BitNV): return "Reserved0BitNV";
        default: return "UNKNOWN";
    }
}
